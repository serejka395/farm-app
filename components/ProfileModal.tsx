    ...
    >
      ...
      <div className="px-8 mt-6">
        <div className="flex gap-2 border-b border-white/5 pb-1">
          {(['main', 'stats', 'security'] as const).map(tab => (
            <button
              key={tab}
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {Object.values(CropType).map(type => {
                    ...
                    return (
                      <div key={type} className={`p-4 rounded-xl border transition-all flex flex-col items-center justify-center gap-2 ${count > 0 ? 'bg-f2e-gold/5 border-f2e-gold/20' : 'bg-white/5 border-transparent opacity-30 select-none'}`}>
