          ...
          {activeTab === 'main' && (
            <motion.div key="main" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
              ...
              <div className="flex flex-col gap-4">
                {/* --- 1. TON NETWORK CONTROL --- */}
                <div className="bg-white p-4 rounded-2xl border-[3px] border-[#D7CCC8] shadow-sm">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-[10px] font-black text-[#8D6E63] uppercase tracking-widest flex items-center gap-1">
                      <span className="text-sm">💎</span> TON Network
                    </span>
                    {isTon && <span className="text-[9px] bg-green-100 text-green-700 px-2 py-0.5 rounded border border-green-200 font-bold">CONNECTED</span>}
                  </div>

                  {isTon ? (
                    <div className="flex flex-col gap-2">
                      <div className="text-xs font-black text-[#5D4037] font-mono bg-[#EFEBE9] p-2 rounded border border-[#D7CCC8] text-center">
                        {truncateAddress(tonAddress)}
                      </div>
                      <button
                        onClick={() => tonConnectUI.disconnect()}
                        className="w-full py-3 rounded-xl bg-[#FFEBEE] border-b-[4px] border-[#FFCDD2] text-[#C62828] text-[10px] font-black uppercase tracking-[0.2em] hover:bg-[#FFCDD2] transition-all shadow-[0_4px_0_#EF9A9A] active:shadow-none active:translate-y-[2px]"
                      >
                        Disconnect TON
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-[#FFCA28] border-b-[4px] border-[#FFA000] text-[#5D4037] text-[10px] font-black uppercase tracking-[0.2em] hover:brightness-105 transition-all shadow-[0_4px_0_#FFA000] active:shadow-none active:translate-y-[2px]"
                    >
                      Connect TON Wallet
                    </button>
                  )}
                ...
                {/* --- 2. SOLANA NETWORK CONTROL --- */}
                <div className="bg-white p-4 rounded-2xl border-[3px] border-[#D7CCC8] shadow-sm">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-[10px] font-black text-[#8D6E63] uppercase tracking-widest flex items-center gap-1">
                      <span className="text-sm">◎</span> Solana Network
                    </span>
